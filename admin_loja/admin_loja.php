    ...
    <div class="container d-flex justify-content-center align-items-center" style="margin-top: 5%;">
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            ...
            <table class="table table-hover">
                ...
                <tbody id="table-body">
                    <tr onclick="window.location.pathname = '../../crud_entrega/crud_entrega.html'" class="link-table">
                        <td class="text-center">1</td>
                        <td class="text-center">22kg</td>
                        <td class="text-center">2000cm x200cm x300cm</td>
                        <td class="text-center">22/05/1912</td>
                        <td class="text-center">Zezinho</td>
                        <td class="text-center">Jogado no mar</td>
                        <td class="text-center">Frágil</td>
                    </tr>
                </tbody>
            </table>
            <div>
