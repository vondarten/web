...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action == 'update') {
        ...
        if ($stmt->rowCount() <= 0) {
            ...
            echo '<script> window.location.href = "crud_entrega_novo.php?error=' . urlencode($message) . '"; </script>';
        } else {
            ...
            if ($stmt->rowCount() <= 0) {
                ...
                if ($update->affected_rows > 0) {
                    echo '<script> window.location.href = "crud_entrega_novo.php?success"; </script>';
                } else {
